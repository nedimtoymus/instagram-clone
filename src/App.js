		...
		<div className="flex flex-wrap items-center justify-center w-full h-full overflow-auto gap-x-8">
			...
			<div className="hidden md:block w-[380px] h-[581px] bg-logo-pattern relative bg-[length:468.32px_634.15px] bg-[top_left_-46px]">
				<div className="w-[250px] h-[538px] absolute top-[27px] right-[18px]" ref={ref}>
					<img className="absolute top-0 left-0 w-full h-full transition-opacity duration-1000 ease-linear opacity-0"
			...
			<div className="w-[350px] grid gap-y-3">
				...
				<div className="p-4 text-sm text-center bg-white border">
